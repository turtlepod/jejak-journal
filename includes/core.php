	...
	wp_localize_script(
		...
		array(
			...
			'i18n'          => array(
				...
				'months'         => array(
					__( 'January', 'jejak-journal' ),
					__( 'February', 'jejak-journal' ),
					__( 'March', 'jejak-journal' ),
					__( 'April', 'jejak-journal' ),
					__( 'May', 'jejak-journal' ),
					__( 'June', 'jejak-journal' ),
					__( 'July', 'jejak-journal' ),
					__( 'August', 'jejak-journal' ),
					__( 'September', 'jejak-journal' ),
					__( 'October', 'jejak-journal' ),
					__( 'November', 'jejak-journal' ),
					__( 'December', 'jejak-journal' ),
				),
				/* translators: %1$s: month name, %2$d: year */
				'import_none'    => __( 'No unchecked items to import from %1$s %2$d.', 'jejak-journal' ),
				'import_failed'  => __( 'Failed to import to-dos.', 'jejak-journal' ),
				'no_prev_entry'  => __( 'No previous month entry found.', 'jejak-journal' ),
			),
			'icons'         => get_icon_list(),
